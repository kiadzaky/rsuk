                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Data Dokter</h2>
                            <p>Berisi semua data singkat dari dokter di RSU Kaliwates.</p>
                        </div>
                        <div class="table-responsive">
                            ...
                            $query = "SELECT * FROM dokter JOIN poli ON dokter.id_poli = poli.id_poli JOIN jadwal ON dokter.id_jadwal = jadwal.id_jadwal";
                                    ...
                                    <?php foreach ($dr as $row) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <button type="button" class="btn btn-danger btn-xs deletebtn"><i class="fa fa-trash-o"></i>Hapus</button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
